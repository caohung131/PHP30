<?php
	...
	function send_email($email_recive,$name,$contents,$subject){
        ...
        $mail->Username   = "hoctaizent123@gmail.com"; // Tên đăng nhập tài khoản Gmail
        $mail->Password   = "Caohung1311"; //Mật khẩu của gmail
        $mail->SetFrom("hoctaizent123@gmail.com", "Test"); // Thông tin người gửi
        $mail->AddReplyTo("hoctaizent123@gmail.com","Zent Group");// Ấn định email sẽ nhận khi người dùng reply lại.
    ...
    $subject = "V/v Học php tại zent";
         send_email("caohung131@gmail.com", "Hoc PHP", $contents, $subject);
?>